...
export const GIF_MAKER_OG_IMAGE = `${GIF_MAKER_ORIGIN}/gif-maker-share.jpg`
export const GIF_MAKER_OG_IMAGE_WIDTH = 1024
export const GIF_MAKER_OG_IMAGE_HEIGHT = 476
